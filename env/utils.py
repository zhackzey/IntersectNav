...
def get_closet_wp(path, cur_loc, debug, draw_dis):
    ...
    if draw_dis:
        ...
        debug.draw_line(cur_loc, temp_loc, thickness=0.5, color=carla.Color(255, 0, 0), life_time=1.0,
...
def get_polygan(debug, veh_loc, yaw_loc, neigh_loc, next_loc, draw_dis):
    if draw_dis:
        debug.draw_line(veh_loc, yaw_loc, thickness=0.5, color=carla.Color(255, 0, 0), life_time=0.2,
                        persistent_lines=False)
        debug.draw_line(yaw_loc, next_loc, thickness=0.5, color=carla.Color(255, 0, 0), life_time=0.2,
                        persistent_lines=False)
        debug.draw_line(next_loc, neigh_loc, thickness=0.5, color=carla.Color(255, 0, 0), life_time=0.2,
                        persistent_lines=False)
        debug.draw_line(neigh_loc, veh_loc, thickness=0.5, color=carla.Color(255, 0, 0), life_time=0.2,
                        persistent_lines=False)
